...
p = {
    ...
    'classifier_args': {'base_estimator': sklearn.linear_model.LogisticRegression(C=5000), 'max_samples':0.5, 'n_estimators':100, 'bootstrap': False},
    'n_negatives': 200,
    'seed': 42,
    'pickled_file_path': const.FEATURIZED_DATA_2_PICKLED_PATH,
    'exclude_features': [0, 1] + range(16, 38)
}
